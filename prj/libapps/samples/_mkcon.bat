...
rem Makes an user application of the InfoSel++ library as a program with the interactive console user interface,
...
cl.exe /O2 /Ob1 /I "..\include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /GF /FD /EHsc /MD /Gy /Fo"out\\" /Fd"out\\" /W0 /c "..\src\conpuse.cpp"
link.exe /OUT:"..\bin\%1.exe" /INCREMENTAL:NO /MANIFEST /MANIFESTFILE:"out\%1.exe.manifest" /SUBSYSTEM:CONSOLE /OPT:NOREF /MACHINE:I386 "out\conpuse.obj" "out\_packuse.obj" "out\%1.obj" "..\lib\iselconsl.lib" "..\lib\iselpacks.lib" "..\lib\infosel++.lib" kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib
