...
#
# Complex multi-valued expressions:
#
 ...
 partition = { equiwidth( {16,24} ) , equidepth( [16..24:2] ) , maxvdiff(24) };  
                           # discretization method of choice and parameters. Here we selected a set of different discretization:
                           # equal-width discretization with 16,24 bins, equal-frequency discretization with 16,18,20,22,24 bins, and equal-variance discretization with 24 bins
                           # this selection is equivalent to:
                           # partition = { equiwidth(16) , equiwidth(24) , equidepth(16) , equidepth(18) , equidepth(20) , equidepth(22) , equidepth(24) , maxvdiff(24) };
 
 exec( mifs( [0.5..0.9:0.1] ) );  # parameter beta is defined in range 0.5 to 0.9 with interval equal 0.1
